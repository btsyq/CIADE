var Module = {
    exhibitorsNumberdatas: function(cb) { //参展企业数量走势数据
        getData(window.baseApiPath + "fair/enterpriseNumberTrend", {}, function(value) {
            var data = {
                year: [],
                Foreign: [],
                Domestic: []
    ...
    audienceNumberTrend: function(cb) { //观展人数走势接口定义
        getData(window.baseApiPath + "fair/audienceNumberTrend", {}, function(value) {
            var data = {
                YearDate: [],
                Number: []
            }
    ...
    tasteDistribution: function(cb) { //展品口味接口定义
        getData(window.baseApiPath + "fair/tasteDistribution", {}, function(value) {
            if (!value.data instanceof Array) return
    ...
    exhibitType: function(cb) { //展品类型数量分布及走向接口定义
        getData(window.baseApiPath + "fair/exhibitType", {}, function(value) {
            var data = {
                Number: [],
                Type: [],
                YearDate: [],
    ...
    provinceRange: function(cb) { //观展企业数-省份排行接口定义
        ...
        getData(window.baseApiPath + "fair/provinceRange", jsonData, function(value) {
            var data = [];
            if (!value.data instanceof Array) return
            value.data.forEach(function(v, i) {
                data.push({
    ...
    alcoholDistribution: function(cb) { //展品酒精度数分布接口定义
        ...
        getData(window.baseApiPath + "fair/alcoholDistribution", {}, function(value) {
            var data = {
                name: [],
            }
            if (!value.data instanceof Array) return
    ...
    enterpriseType: function(cb) { //参展酒企类型分布接口定义
        getData(window.baseApiPath + "fair/enterpriseType", {}, function(value) {
            var data = {
                Number: [],
                Number2: [],
                Type: [],
    ...
    opinionHotWord: function(cb) { //舆情热词接口定义
        getData(window.baseApiPath + "fair/opinionHotWord", {}, function(value) {
            var data = {
                Word: [],
            }
            if (!value.data instanceof Array) return
    ...
    opinionPush: function(cb) { //舆情推送接口定义
        getData(window.baseApiPath + "fair/opinionPush", {}, function(value) {
            var data = []
            if (!value.data instanceof Array) return
            value.data.forEach(function(v, i) {
                if (i > 8) {
    ...
    opinionStatistics: function(cb) { //舆情统计接口定义
        getData(window.baseApiPath + "fair/opinionStatistics", {}, function(value) {
            var data = []
            if (!value.data instanceof Array) return
            value.data.forEach(function(v, i) {
                if (i > 8) {
    ...
    opinionRange: function(cb) { //舆情文章类型分布接口定义
        getData(window.baseApiPath + "fair/opinionRange", {}, function(value) {
            var data = {
                z: [],
                f: [],
                z1: [],
    ...
    indexAmount: function(cb) { //地图
        getData(window.baseApiPath + "fair/indexAmount", {}, function(value) {
            if (!value.data instanceof Array) return
            value.data.forEach(function(v) {
                v.id = v.province
                v.gravity = v.number
    ...
    globleEnterprise: function(cb) { //地图2
        getData(window.baseApiPath + "fair/globleEnterprise", {}, function(value) {
            if (!value.data instanceof Array) return
            value.data.forEach(function(v) {
                v.id = v.name
                v.gravity = v.amount
    ...
    conutryInfo: function(cb) { //参展国信息
        getData(window.baseApiPath + "fair/conutryInfo", {}, function(value) {
